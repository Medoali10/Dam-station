  ...
  void initState() {
    ...
    databaseRef.onValue.listen((event) {
      if(event.snapshot.exists){
        print(pow(event.snapshot.value["vin"], 2) / 11.2);
        productImages[0] = event.snapshot.value["vin"];
        productImages[1] = double.parse((pow(event.snapshot.value["vin"], 2) / 11.2).toStringAsPrecision(5)); //volt * current
        productImages[2] = double.parse(((pow(event.snapshot.value["vin"], 2) / 11.2 / (pow(event.snapshot.value['flowRate'], 3) * 1.133 * pow(10,-4))) * 100).toStringAsPrecision(2));
        history.add({
                              ...
                              child: ListTile(
                                ...
                                trailing: SizedBox(
                                  ...
                                  child: FittedBox(
                                    ...
                                    child: Text(productImages[index].toString() + unit[index],
                                        style: TextStyle(
                                            fontSize: 24,
                                            fontWeight: FontWeight.w700,
                                            color: Colors.blue)),
